...
import br.com.inspectflow.infrastructure.persistence.postgres.repositories.PostgresStockItemRepository;
...
public class JpaStockItemRepositoryAdapter implements StockItemRepository {
    ...
    @Override
    public List<StockItem> findByNameStartingWithIgnoreCase(String name) {
