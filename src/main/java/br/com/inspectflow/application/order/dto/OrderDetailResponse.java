...
public record OrderDetailResponse(
        ...
        Set<OrderAttachmentResponse> documents,
        LocalDateTime createdAt
) {
    public static OrderDetailResponse from(WorkOrder order) {
        return new OrderDetailResponse(
                ...
                order.getDocuments().stream().map(OrderAttachmentResponse::from).collect(Collectors.toSet()),
                order.getCreatedAt()
